...
const isAnimationAboutmeBottom = ref(false);

// methods
/* MouseOver For AboutMe */
function goAnimationAboutMeMouseOver() {
  isAnimationAboutmeTop.value = true;
}

/* MouseLeave For AboutMe */
